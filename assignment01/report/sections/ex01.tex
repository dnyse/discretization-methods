...
% We can expand equation \eqref{eq:6order} by writing the sum with its coefficients explicitly:
% \begin{equation}
% 	\begin{aligned}
% 		u(x) & = u_{j-3} \frac{(x - x_{j-2})}{(x_{j-3}-x_{j-2})} \frac{(x - x_{j-1})}{(x_{j-3}-x_{j-1})} \frac{(x - x_{j})}{(x_{j-3}-x_{j})} \frac{(x - x_{j+1})}{(x_{j-3}-x_{j+1})} \frac{(x - x_{j+2})}{(x_{j-3}-x_{j+2})} \frac{(x - x_{j+3})}{(x_{j-3}-x_{j+3})} \\
% 		     & + u_{j-2} \frac{(x - x_{j-3})}{(x_{j-2}-x_{j-3})} \frac{(x - x_{j-1})}{(x_{j-2}-x_{j-1})} \frac{(x - x_{j})}{(x_{j-2}-x_{j})} \frac{(x - x_{j+1})}{(x_{j-2}-x_{j+1})} \frac{(x - x_{j+2})}{(x_{j-2}-x_{j+2})} \frac{(x - x_{j+3})}{(x_{j-2}-x_{j+3})} \\
% 		     & + u_{j-1} \frac{(x - x_{j-3})}{(x_{j-1}-x_{j-3})} \frac{(x - x_{j-2})}{(x_{j-1}-x_{j-2})} \frac{(x - x_{j})}{(x_{j-1}-x_{j})} \frac{(x - x_{j+1})}{(x_{j-1}-x_{j+1})} \frac{(x - x_{j+2})}{(x_{j-1}-x_{j+2})} \frac{(x - x_{j+3})}{(x_{j-1}-x_{j+3})} \\
% 		     & + u_{j} \frac{(x - x_{j-3})}{(x_{j}-x_{j-3})} \frac{(x - x_{j-2})}{(x_{j}-x_{j-2})} \frac{(x - x_{j-1})}{(x_{j}-x_{j-1})} \frac{(x - x_{j+1})}{(x_{j}-x_{j+1})} \frac{(x - x_{j+2})}{(x_{j}-x_{j+2})} \frac{(x - x_{j+3})}{(x_{j}-x_{j+3})}           \\
% 		     & + u_{j+1} \frac{(x - x_{j-3})}{(x_{j+1}-x_{j-3})} \frac{(x - x_{j-2})}{(x_{j+1}-x_{j-2})} \frac{(x - x_{j-1})}{(x_{j+1}-x_{j-1})} \frac{(x - x_{j})}{(x_{j+1}-x_{j})} \frac{(x - x_{j+2})}{(x_{j+1}-x_{j+2})} \frac{(x - x_{j+3})}{(x_{j+1}-x_{j+3})} \\
% 		     & + u_{j+2} \frac{(x - x_{j-3})}{(x_{j+2}-x_{j-3})} \frac{(x - x_{j-2})}{(x_{j+2}-x_{j-2})} \frac{(x - x_{j-1})}{(x_{j+2}-x_{j-1})} \frac{(x - x_{j})}{(x_{j+2}-x_{j})} \frac{(x - x_{j+1})}{(x_{j+2}-x_{j+1})} \frac{(x - x_{j+3})}{(x_{j+2}-x_{j+3})} \\
% 		     & + u_{j+3} \frac{(x - x_{j-3})}{(x_{j+3}-x_{j-3})} \frac{(x - x_{j-2})}{(x_{j+3}-x_{j-2})} \frac{(x - x_{j-1})}{(x_{j+3}-x_{j-1})} \frac{(x - x_{j})}{(x_{j+3}-x_{j})} \frac{(x - x_{j+1})}{(x_{j+3}-x_{j+1})} \frac{(x - x_{j+2})}{(x_{j+3}-x_{j+2})}
% 	\end{aligned}
% 	\label{eq:6order_expl}
% \end{equation}
% We can now replace each denominator in \eqref{eq:6order_expl} with the appropriate multiple of $\Delta x$, where $x_{j+1} - x_j = \Delta x$ for all $j$, due to the grid points being equidistant from each other.
% \begin{equation}
% 	\begin{aligned}
% 		u(x) & = u_{j-3} \frac{(x - x_{j-2})}{(-\Delta x)} \frac{(x - x_{j-1})}{(-2\Delta x)} \frac{(x - x_{j})}{(-3\Delta x)} \frac{(x - x_{j+1})}{(-4\Delta x)} \frac{(x - x_{j+2})}{(-5\Delta x)} \frac{(x - x_{j+3})}{(-6\Delta x)} \\
% 		     & + u_{j-2} \frac{(x - x_{j-3})}{(\Delta x)} \frac{(x - x_{j-1})}{(-\Delta x)} \frac{(x - x_{j})}{(-2\Delta x)} \frac{(x - x_{j+1})}{(-3\Delta x)} \frac{(x - x_{j+2})}{(-4\Delta x)} \frac{(x - x_{j+3})}{(-5\Delta x)}   \\
% 		     & + u_{j-1} \frac{(x - x_{j-3})}{(2\Delta x)} \frac{(x - x_{j-2})}{(\Delta x)} \frac{(x - x_{j})}{(-\Delta x)} \frac{(x - x_{j+1})}{(-2\Delta x)} \frac{(x - x_{j+2})}{(-3\Delta x)} \frac{(x - x_{j+3})}{(-4\Delta x)}    \\
% 		     & + u_{j} \frac{(x - x_{j-3})}{(3\Delta x)} \frac{(x - x_{j-2})}{(2\Delta x)} \frac{(x - x_{j-1})}{(\Delta x)} \frac{(x - x_{j+1})}{(-\Delta x)} \frac{(x - x_{j+2})}{(-2\Delta x)} \frac{(x - x_{j+3})}{(-3\Delta x)}     \\
% 		     & + u_{j+1} \frac{(x - x_{j-3})}{(4\Delta x)} \frac{(x - x_{j-2})}{(3\Delta x)} \frac{(x - x_{j-1})}{(2\Delta x)} \frac{(x - x_{j})}{(\Delta x)} \frac{(x - x_{j+2})}{(-\Delta x)} \frac{(x - x_{j+3})}{(-2\Delta x)}      \\
% 		     & + u_{j+2} \frac{(x - x_{j-3})}{(5\Delta x)} \frac{(x - x_{j-2})}{(4\Delta x)} \frac{(x - x_{j-1})}{(3\Delta x)} \frac{(x - x_{j})}{(2\Delta x)} \frac{(x - x_{j+1})}{(\Delta x)} \frac{(x - x_{j+3})}{(-\Delta x)}       \\
% 		     & + u_{j+3} \frac{(x - x_{j-3})}{(6\Delta x)} \frac{(x - x_{j-2})}{(5\Delta x)} \frac{(x - x_{j-1})}{(4\Delta x)} \frac{(x - x_{j})}{(3\Delta x)} \frac{(x - x_{j+1})}{(2\Delta x)} \frac{(x - x_{j+2})}{(\Delta x)}
% 	\end{aligned}
% 	\label{eq:6order_expl_delta}
% \end{equation}
